from ..example import pd_in_t, CassieSim, CassieVis

#import sys
#sys.path.append('/home/qi/Documents/github/cassie/RSS-2020-learning-memory-based-control/cassie')
...
class CassieEnv(gym.Env):
    ...
    def __init__(self, simrate=60, clock_based=False):
